<template>
    <div class="product">
        <pageTitle name="新闻资讯列表"></pageTitle>
            ...
            <div class="e_body">
                <el-form :model="userForm" ref="ruleFormRef" :rules="rules" label-width="70">
                    <el-form-item label="标题:" prop="title">
                        <el-input v-model="userForm.title" placeholder="请输入用户名" />
                    </el-form-item>
                    <el-form-item label="链接:" prop="url">
                        <el-input v-model.number="userForm.url" placeholder="请输入跳转链接" />
                    </el-form-item>
...
<script setup lang="ts">
    ...
    import { getInfo, addInfo, editInfo, delInfo } from './news.ts'
