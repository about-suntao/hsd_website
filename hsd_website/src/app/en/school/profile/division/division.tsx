...
function Division() {
  ...
  const str2 = `Huashengda Foreign Language School is a Foxcroft Academy Friendly School, an Edexcel Authorised Examination Centre, an official UCAS Registration Centre, and an official test centre for the ASDAN International Science Competition.`
